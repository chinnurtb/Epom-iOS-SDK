//
//  ESProviderBannerMillenialMedia.m
...
#import "ESProviderBannerMillennialMedia.h"
...
@implementation ESProviderBannerMillennialMedia
...
- (id)initWithParameters:(NSDictionary *)params sizeType:(ESBannerViewSizeType)size delegate:(id<ESProviderBannerDelegate>)delegate_
{
	...
	CGRect sizes[] =
	{
		/*ESBannerViewSize320x50	*/	CGRectMake(0, 0, 320, 53),
...
{
	ES_LOG_ERROR(@"MillennialMedia banner ad request failed: (unknown)");
