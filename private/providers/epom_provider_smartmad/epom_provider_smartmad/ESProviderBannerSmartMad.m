//
//  ESProviderBannerSmartMad.m
//  ESProviderBannerSmartMad
//
//  Created by Epom LTD on 9/7/12.
//  Copyright (c) 2012 Epom LTD. All rights reserved.
//

#import "ESProviderBannerSmartMad.h"
...
@interface ESProviderBannerSmartMad ()
...
@implementation ESProviderBannerSmartMad
...
- (id)initWithParameters:(NSDictionary *)params sizeType:(ESBannerViewSizeType)size delegate:(id<ESProviderBannerDelegate>)delegate_
{
	...
	{
		/*ESBannerViewSize320x50*/ AD_MEASURE_DEFAULT,
		/*ESBannerViewSize768x90*/ TABLET_AD_MEASURE_728X90,
	};
