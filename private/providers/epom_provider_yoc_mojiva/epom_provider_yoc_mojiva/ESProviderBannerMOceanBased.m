...
#import "ESProviderBannerMOceanBased.h"
...
@implementation ESProviderBannerMOceanBased
...
{
	ES_LOG_ERROR(@"%@ banner ad request failed: %@", [self adNetworkName], error);
